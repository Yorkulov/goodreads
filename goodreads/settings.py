...
SECRET_KEY = 'django-insecure-szzr@97vgmdubg5h4$bl!89i8ort=5e^)!oo6k!m=sz!dpgfbx'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'goodreads',  # new database name 'goodreads'
        'USER': 'yorkulov',  # postgresql user name
